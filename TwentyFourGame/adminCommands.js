// ============================================================
//  adminCommands.js — The 24 Game (M4T) · Sky Graphics
//  Handles "/m4th ..." admin commands. Game switching itself
...
async function handleAdminCommand(ctx) {
    ...
    const m4th = settings.m4th || {}

    switch (cmd) {
        case 'setroundtime': {
            const n = parseInt(arg, 10)
            if (!Number.isInteger(n) || n < 5 || n > 120) {
                await reply(`⚠️ Give a number of seconds between 5 and 120.`)
                return true
            }
            settings.m4th = { ...m4th, roundSeconds: n }
            saveSettings()
        ...
        case 'setcooldown': {
            ...
            settings.m4th = { ...m4th, cooldownSeconds: n }
            saveSettings()
        ...
        case 'setrounds': {
            ...
            settings.m4th = { ...m4th, roundsPerSession: val }
            saveSettings()
        ...
        case 'setsessioncooldown': {
            ...
            settings.m4th = { ...m4th, sessionCooldown: n }
            saveSettings()
        ...
        case 'status': {
            const gameState = gameEngine.getGameState(chatId, games)
            const cfg = gameEngine.getM4thSettings(settings)
            await reply(
        ...
        default: {
            await reply(
                ...
                `${config.ADMIN_PREFIX}setroundtime <5-120>\n` +
